...
(c) Elements having different properties were placed in the same sub group like manganese (Mn) was placed with halogens which had totally different properties
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 20    )</h2>
    ...
    <div class="value-img">
      <img src="2/20.jpg" data-action="zoom" data-original="2/20.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
