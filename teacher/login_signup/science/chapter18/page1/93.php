...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 93  )</h2>
    ...
    <div class="value-img">
      <img src="18/93.jpg" data-action="zoom" data-original="18/93.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
