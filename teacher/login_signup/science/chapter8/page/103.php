...
Aluminium ore is called bauxite . The bauxite is purified to produce aluminium oxide, a white powder from which aluminium can be extracted.
 The extraction is done by electrolysis. The ions in the aluminium oxide must be free to move so that electricity can pass through it.</p>
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 103   )</h2>
    ...
    <div class="value-img">
      <img src="8/103.jpg" data-action="zoom" data-original="8/103.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
