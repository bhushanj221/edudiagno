...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 15   )</h2>

    <div class="value-img">
      <img src="12/15.jpg" data-action="zoom" data-original="12/15.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
