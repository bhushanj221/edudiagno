...
<div class="container">
 ...
 <b>How do you Write a Chemical Equation?</b>
...
The symbols and formulae of the substances (elements or compounds) are arranged to show the reactants and products of a chemical reaction.<br>
...
For example:
How do you Write a Chemical Equation 1
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 32   )</h2>
    ...
    <div class="value-img">
      <img src="3/32.jpg" data-action="zoom" data-original="3/32.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
