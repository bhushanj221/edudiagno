...
<br><br><br>
 A catalyst increases the rate of reaction by providing a new path with lower activation energy (Ea’) for the reaction. 
<br><br>
What is Oxidation?
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 41    )</h2>
    ...
    <div class="value-img">
      <img src="3/41.jpg" data-action="zoom" data-original="3/41.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
