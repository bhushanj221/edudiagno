...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 49   )</h2>

    <div class="value-img">
      <img src="4/49.jpg" data-action="zoom" data-original="4/49.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
