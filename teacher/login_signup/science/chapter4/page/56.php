...
<br><br><br>
Without the motor, we had still been living in Sir Thomas Edison’s Era where the only purpose of electricity would have been to glow bulbs. There are different types of motor have been developed for different specific purposes.
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 56    )</h2>
    ...
    <div class="value-img">
      <img src="4/56.jpg" data-action="zoom" data-original="4/56.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
