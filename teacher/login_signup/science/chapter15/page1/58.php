...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 58  )</h2>

    <div class="value-img">
      <img src="15/58.jpg" data-action="zoom" data-original="15/58.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
