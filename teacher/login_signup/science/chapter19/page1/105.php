...
<h1 style="  color: white;
  text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; text-align: center;">Types of cybercrime</h1>
<br>
<b>Here are some specific examples of the different types of cybercrime:</b><br>
<ul>
...
<li>Cryptojacking (where hackers mine cryptocurrency using resources they do not own).</li>
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 105   )</h2>
    ...
    <div class="value-img">
      <img src="19/105.jpg" data-action="zoom" data-original="19/105.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
