...
<div class="container">
 ...
 If we go deeper, g decreases. ... During the derivation of the formula for the variation of g with depth we found that g' = g(1- d/R), where, d is the depth of the object from the surface, R is the radius of the earth and g is the acceleration due to gravity at the surface.
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 9   )</h2>
    ...
    <div class="value-img">
      <img src="1/9.jpg" data-action="zoom" data-original="1/9.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
