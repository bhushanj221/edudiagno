...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 13    )</h2>

    <div class="value-img">
      <img src="1/13.jpg" data-action="zoom" data-original="1/13.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
