...
<div class="container">
 ...
 First Law: Planetary orbits are elliptical with the sun at a focus.   - Johannes Kepler
<br><br>
Second Law: The radius vector from the sun to a planet sweeps equal areas in equal times. - Johannes Kepler
<br><br>
Third Law: The ratio of the square of the period of revolution and the cube of the ellipse semimajor axis is the same for all planets. - Johannes Kepler
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 3    )</h2>
    ...
    <div class="value-img">
      <img src="1/3.jpg" data-action="zoom" data-original="1/3.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
