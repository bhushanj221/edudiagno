...
<div class="container">
  ...
  <p >The two laws followed by a beam of light traversing through two media are: The incident ray refracted ray, and the normal to the interface of two media at the point of incidence all lie on the same plane. The ratio of the sine of the angle of incidence to the sine of the angle of refraction is a constant.
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 74    )</h2>
    ...
    <div class="value-img">
      <img src="6/74.jpg" data-action="zoom" data-original="6/74.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
