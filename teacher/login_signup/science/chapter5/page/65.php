...
The reference below gives graphs of Hope's experiments (in his paper he only gave tables), plus additional experiments run by the author in 1981.</p>
...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 65    )</h2>
    ...
    <div class="value-img">
      <img src="5/65.jpg" data-action="zoom" data-original="5/65.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
