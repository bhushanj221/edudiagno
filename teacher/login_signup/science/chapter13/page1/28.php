...
<div class="container">
  ...
  text-shadow: 1px 1px 2px red, 0 0 25px red, 0 0 5px darkred;">Text Book (page.no 28   )</h2>

    <div class="value-img">
      <img src="13/28.jpg" data-action="zoom" data-original="13/28.jpg" alt="journey_start_thumbnail" />
    </div>
  </section>
